...
- `b228ab9…` remains a rejected Candidate. This second-round remediation has completed final local
  verification and awaits publication and independent main-thread review; neither step is a B7
  acceptance decision.
...
- No unresolved observable-product conflict is known in the frozen v6 timing, Fact or transition
  contract. The implementation chooses only the permitted deterministic subvalue encoding.
