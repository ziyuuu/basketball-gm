...
- 文档状态：`OWNER_APPROVED`
- 编制日期：2026-08-01
- Owner 批准日期：2026-08-01；12 人球队修订：2026-08-02；单场体力与强制错位修订：2026-08-06
- 权威玩法输入：`docs/P02_GAMEPLAY_BASELINE.md` v1.3
...
主动五人错配场景删除，不以另一种主动错位夹具替代。强制错位改为 P02-003 定点合同测试：
有对应主位置候选时不得错位；对应位置无人可用时必须确定性触发一次统一能力惩罚并记录
结构化原因；主位置候选重新可用后恢复正常轮换。P02-003 先通过明显强弱队、高低耐力
