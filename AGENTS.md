...
- The Owner-approved P02 gameplay authority is `docs/P02_GAMEPLAY_BASELINE.md` v1.3, as narrowly amended for P02-003 and downstream player-model work by `docs/design/P02-003/v2.9-r1-final/P02_GAMEPLAY_BASELINE_AMENDMENT.md` and, for single-match energy plus forced position mismatch, by `docs/design/P02-003/P02_SINGLE_MATCH_ENERGY_AND_FORCED_MISMATCH_AMENDMENT.md`. The later amendment wins only for the exact clauses it replaces. For P02-003, versioned files under `docs/design/P02-003/v2.9-r1-final/errata/` take precedence over the exact clauses they correct unless the 2026-08-06 amendment explicitly replaces them. Do not reinterpret the authority from superseded vision or audit drafts.
- The Owner-approved implementation authority is `docs/P02_DEVELOPMENT_PLAN.md` v1.3. Implement it through one unblocked GitHub Issue and one independently reviewable PR at a time.
